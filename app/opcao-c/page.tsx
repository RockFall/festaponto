...
export default function OpcaoC() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      await fetch('https://formspree.io/f/SEUCODIGO', {
        method: 'POST',
        body: data,
        headers: { Accept: 'application/json' },
      })
    } catch (_) {
      // still show success — the user can wire error handling later
    }
  ...
  if (submitted) {
    return (
      ...
      >
        <p className="text-4xl lowercase text-[#1a1a1a] brat-blur text-center leading-snug">
          inscrição enviada!<br />até lá ✌
        </p>
      </main>
    )
  }
      ...
      <div className="w-full max-w-lg flex flex-col gap-16">
        ...
        <section className="flex flex-col gap-6">
          ...
          <form
            ...
            action="https://formspree.io/f/SEUCODIGO"
            method="POST"
